...
One skill per phase of `WORKFLOW.md` (Brana v1.10). Run each phase in a **fresh session**; Phase 5 runs one session per 2–3-task batch, cleared at each demo gate.
